...
public class Scene {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                switch (cmd) {
                    ...
                    /*case "HEART":
                        ...
                        parts2 = args.split(",");
                        if (parts2.length != 2) continue;
                        int heartX = Integer.parseInt(parts2[0].trim()) * 10;
                        int heartY = Integer.parseInt(parts2[1].trim()) * 10;
                        Heart heart = new Heart(gameEngine, heartX, heartY);
                        hearts.add(heart);
                        break;*/
                }
            }
    ...
    public int getRemainingHearts(){ return  remainingHearts; }
    public void setRemainingHearts(int setHearts){remainingHearts = setHearts;}
    ...
    void physics(int delta) {
        ...
        for(Heart heart : hearts) heart.physics(delta);
    ...
    void draw(Canvas canvas, int offsetX, int offsetY, int screenWidth, int screenHeight) {
        ...
        for(Heart heart : hearts) heart.draw(canvas);
